...
export const MsgBubble = ({ msg, delay: d }: { msg: Msg; delay: number }) => {
  ...
  return (
    ...
    >
      {/* Avatar */}
      <div
        className={`w-8 h-8 rounded-xl shrink-0 flex items-center justify-center transition-all duration-500 shadow-sm
        ${
          isAgent
            ? "bg-linear-to-br from-brand-green to-emerald-600 border-none text-white shadow-brand-green/20"
      ...
      >
              ...
              <div className="space-y-1.5">
                {msg.steps.map((s, i) => (
                  ...
                  >
                    ...
                    <span className="text-[9px] font-bold text-emerald-800/60 uppercase tracking-tight">
                      {s.label}
                    </span>
                  </div>
                ))}
        ...
        {msg.text && (
          <div
            className={`px-4 py-3 text-sm leading-relaxed font-medium wrap-break-word shadow-sm
              ${
                isAgent
